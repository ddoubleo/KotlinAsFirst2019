 ...
 */
fun seconds(hours: Int, minutes: Int, seconds: Int): Int = 3600 * hours + 60 * minutes +seconds+0
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = deg * 3.14159/180 + min * 3.14159/10800 + sec * 3.14159/648000
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * percent * percent * percent * 0.001
